...
def plot_spec(audio_data: np.ndarray, sr: int, title: str = 'Spectrogram') -> None:
    # Calculate the spectrogram
    frequencies, times, Sxx = spectrogram(audio_data.squeeze(), fs=sr)
...
def play_audio(waveform, sr: int = 16000) -> None:
